...
Additionally, we offer a feature to create a <b>Family Account 👨‍👩‍👧‍👧</b> so everyone can manage the budget together. For more details, visit /help.
...
Додатково ми пропонуємо функціонал для створення <b>Сімейного акаунту 👨‍👩‍👧‍👧</b>, щоб кожен міг управляти бюджетом разом. Деталі на /help.
